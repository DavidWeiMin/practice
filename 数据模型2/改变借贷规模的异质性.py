...
m1 = 30
leverage = np.linspace(0.01,0.3,m1)
m2 = 3
gamma = np.linspace(1.02,4,m2)
shock = np.ones(N) * 0.4
...
for i in gamma:
    L = balanceSheet(r,100,i)                                   # 得到借贷规模矩阵
    IL = sum(L)                                                     # 银行间贷款
    L = L.T
    IB = sum(L)                                                     # 银行间借款
    for p in leverage:
...
legend = ['幂律分布参数=%f' % round(i,2) for i in gamma]
for i in range(m2):
...
plt.legend(legend)
fig1.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：1-基础违约银行数量平均数————杠杆')
...
plt.legend(legend)
fig2.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：2-基础违约银行数量中位数————杠杆')
...
plt.legend(legend)
fig3.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：3-基础违约银行数量VaR————杠杆')
...
plt.legend(legend)
fig4.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：4-基础违约银行数量ES————杠杆')
...
plt.legend(legend)
fig5.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：5-传染违约银行数量平均数————杠杆')
...
plt.legend(legend)
fig6.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：6-传染违约银行数量中位数————杠杆')
...
plt.legend(legend)
fig7.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：7-传染违约银行数量VaR————杠杆')
...
plt.legend(legend)
fig8.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：8-传染违约银行数量ES———杠杆')
...
plt.legend(legend)
fig9.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：9-总违约银行数量平均数————杠杆')
...
plt.legend(legend)
fig10.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：10-总违约银行数量中位数————杠杆')
...
plt.legend(legend)
fig11.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：11-总违约银行数量VaR————杠杆')
...
plt.legend(legend)
fig12.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：12-总违约银行数量ES————杠杆')
...
plt.legend(legend)
fig13.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：13-平均违约损失率平均数————杠杆')
...
plt.legend(legend)
fig14.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：14-平均违约损失率中位数————杠杆')
...
plt.legend(legend)
fig15.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：15-平均违约损失率VaR————杠杆')
...
plt.legend(legend)
fig16.savefig('D:/Documents/GitHub/practice/数据模型2/改变借贷规模的异质性：16-平均违约损失率ES————杠杆')
