...
L = L.T
IB = sum(L) # 银行间借款
leverage = np.linspace(0.01,0.45,100)
fundamental_number = []
contagion_number = []
default_number = []
LGD_avg = []
...
fig4.savefig('D:/Documents/GitHub/practice/数据模型2/违约银行数量————杠杆')
...
plt.xlabel('杠杆')
plt.ylabel('传染概率')
fig5.savefig('D:/Documents/GitHub/practice/数据模型2/传染概率————杠杆')
...
plt.xlabel('杠杆')
plt.ylabel('平均违约损失率')
fig6.savefig('D:/Documents/GitHub/practice/数据模型2/平均违约损失率————杠杆')